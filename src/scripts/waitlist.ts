...
const roleInput = document.getElementById("waitlist-role") as HTMLInputElement | null;
const websiteInput = document.getElementById("waitlist-website") as HTMLInputElement | null;
const noteInput = document.getElementById("waitlist-note") as HTMLTextAreaElement | null;
const statusEl = document.getElementById("waitlist-status") as HTMLParagraphElement | null;
const submitBtn = document.getElementById("waitlist-submit") as HTMLButtonElement | null;
const resetBtn = document.getElementById("waitlist-reset") as HTMLButtonElement | null;

if (!form || !emailInput || !statusEl || !submitBtn) {
  console.error("[waitlist] missing required form elements.");
}

const env = (window as any).__GEO_PUBLIC__ || {};
...
function lockWithEmail(email: string, message: string) {
...
function overLimit(value: string, max: number) {
